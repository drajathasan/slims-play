 ...
 * @modify date 2022-09-05 12:24:51
 * @license GPLv3
 * @desc [description]
 */
...
<html>
    ...
    <body>
        <section id="app">
            <router-view site-name="<?= $sysconf['library_name'] ?>" site-subname="<?= $sysconf['library_subname'] ?>" site-logo="<?= $sysconf['logo_image']??'none' ?>"></router-view>
        </section>
